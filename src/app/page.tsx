        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-5 gap-4 mb-32 items-center">
            ...
            <div className="hidden md:flex justify-center">
              <svg className="w-12 h-12 text-red-500 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="grid md:grid-cols-5 gap-4 items-center">
            ...
            {/* Green Arrow 1 */}
            <div className="hidden md:flex justify-center">
              <svg className="w-12 h-12 opacity-70" style={{color: '#60ea8b'}} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </div>
